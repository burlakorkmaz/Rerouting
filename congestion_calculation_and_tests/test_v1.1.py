...
for z in range(0, 15):
    ...
    for i in range(bboxes.shape[0]):
        if(abs((bboxes[i][2] - bboxes[i][0]) - (bboxes[i][3] - bboxes[i][1])) < int(round(avg_env/100*14))):
            #çapraz    
    ...
    for i in range(bboxes2.shape[0]):
        if(abs((bboxes2[i][2] - bboxes2[i][0]) - (bboxes2[i][3] - bboxes2[i][1])) < int(round(avg_env/100*14))):
            #çapraz    
