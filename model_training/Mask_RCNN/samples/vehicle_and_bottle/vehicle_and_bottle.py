...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("vehicle_and_bottle", 1, "vehicle")
        self.add_class("vehicle_and_bottle", 2, "bottle")
        ...
        for a in annotations:
            ...
            self.add_image(
                "vehicle_and_bottle",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "vehicle_and_bottle":
    ...
    def image_reference(self, image_id):
        ...
        info = self.image_info[image_id]
        if info["source"] == "vehicle_and_bottle":
            return info["path"]
        else:
